module Fedex
  ...
  class Rate
    ...
    attr_accessor :service_type, :transit_time, :rate_type, :rate_zone, :total_billing_weight, :total_freight_discounts, :total_net_charge, :total_taxes, :total_net_freight, :total_surcharges, :total_base_charge, :surcharges, :delivery_timestamp
    def initialize(options = {})
      ...
      @surcharges = [options[:surcharges]].flatten

      if options[:special_rating_applied] == "FEDEX_ONE_RATE"
        @total_billing_weight = "FEDEX ONE RATE"
      else
